...
from estudio_scraper import obtener_datos_preview_ligero
    ...
    for test_id in test_match_ids:
        ...
        try:
            ...
            if "recent_indirect" in result:
                ...
                print("  ❌ No 'recent_indirect' data found in result")
        
        except Exception as e:
            print(f"  ❌ Exception occurred for match ID {test_id}: {str(e)}")
