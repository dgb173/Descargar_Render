        ...
        try:
            ...
            if key_id_a and rival_a_id and rival_b_id:
                ...
                if col3 and col3.get('status') == 'found':
                    ...
                    ah_raw = col3.get('handicap_line_raw') or col3.get('handicap') or '-'
...
def obtener_datos_preview_ligero(match_id: str):
    ...
    try:
        ...
        try:
            ...
            # H2H Rivales (Col3) usando la misma lógica Selenium que en obtener_datos_preview_rapido
            key_id_a, rival_a_id, rival_a_name = get_rival_a_for_original_h2h_of(soup, league_id)
            _, rival_b_id, rival_b_name = get_rival_b_for_original_h2h_of(soup, league_id)

            if key_id_a and rival_a_id and rival_b_id:
                # Creamos un driver headless temporal SOLO para sacar el AH real
                ...
                if col3 and col3.get("status") == "found":
                    ...
                    # Stats in-game (disparos, ataques peligrosos...) del partido Col3
                    col3_stats_df = get_match_progression_stats_data(str(col3.get('match_id')))
